...
/**
 * Validation framework class 362 with rule-based validation.
 */
public class Validator362<T> {
    ...
    public Validator362<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator362<T> stopOnFirst(boolean stop) {
