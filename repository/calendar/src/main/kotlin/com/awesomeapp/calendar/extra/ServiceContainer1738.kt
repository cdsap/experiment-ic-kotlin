...
class ServiceContainer1738 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1738) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1738) -> T
    ): ServiceContainer1738 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1738) -> T
