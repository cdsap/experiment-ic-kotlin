...
class RateLimiter710(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter710>()
    ...
    fun forKey(key: String): RateLimiter710 = perKeyLimiters.getOrPut(key) { RateLimiter710(strategy) }
