...
class ServiceContainer1198 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1198) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1198) -> T
    ): ServiceContainer1198 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1198) -> T
