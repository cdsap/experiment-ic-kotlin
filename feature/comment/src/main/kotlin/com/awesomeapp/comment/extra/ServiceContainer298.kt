...
class ServiceContainer298 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer298) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer298) -> T
    ): ServiceContainer298 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer298) -> T
