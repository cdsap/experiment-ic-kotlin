...
class ServiceContainer18 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer18) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer18) -> T
    ): ServiceContainer18 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer18) -> T
