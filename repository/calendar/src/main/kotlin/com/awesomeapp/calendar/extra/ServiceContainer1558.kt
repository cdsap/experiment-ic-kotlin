...
class ServiceContainer1558 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1558) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1558) -> T
    ): ServiceContainer1558 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1558) -> T
