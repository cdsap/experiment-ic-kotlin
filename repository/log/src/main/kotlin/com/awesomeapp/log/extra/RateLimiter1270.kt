...
class RateLimiter1270(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1270>()
    ...
    fun forKey(key: String): RateLimiter1270 = perKeyLimiters.getOrPut(key) { RateLimiter1270(strategy) }
