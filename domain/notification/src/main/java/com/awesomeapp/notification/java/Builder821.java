...
public class Builder821 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder821 withType(String type) { this.type = type; return this; }

    public Builder821 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder821 withProperties(Map<String, Object> props) {
    ...
    public Builder821 reset() { properties.clear(); type = "default"; return this; }
}
