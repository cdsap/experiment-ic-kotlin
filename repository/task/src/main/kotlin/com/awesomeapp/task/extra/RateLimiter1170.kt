...
class RateLimiter1170(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1170>()
    ...
    fun forKey(key: String): RateLimiter1170 = perKeyLimiters.getOrPut(key) { RateLimiter1170(strategy) }
