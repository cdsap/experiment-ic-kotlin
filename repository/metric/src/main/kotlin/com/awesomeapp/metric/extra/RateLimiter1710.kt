...
class RateLimiter1710(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1710>()
    ...
    fun forKey(key: String): RateLimiter1710 = perKeyLimiters.getOrPut(key) { RateLimiter1710(strategy) }
