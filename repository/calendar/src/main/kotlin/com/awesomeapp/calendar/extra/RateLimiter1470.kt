...
class RateLimiter1470(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1470>()
    ...
    fun forKey(key: String): RateLimiter1470 = perKeyLimiters.getOrPut(key) { RateLimiter1470(strategy) }
