...
class RateLimiter10(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter10>()
    ...
    fun forKey(key: String): RateLimiter10 = perKeyLimiters.getOrPut(key) { RateLimiter10(strategy) }
