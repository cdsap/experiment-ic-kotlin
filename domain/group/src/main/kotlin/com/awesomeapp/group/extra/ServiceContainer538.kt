...
class ServiceContainer538 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer538) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer538) -> T
    ): ServiceContainer538 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer538) -> T
