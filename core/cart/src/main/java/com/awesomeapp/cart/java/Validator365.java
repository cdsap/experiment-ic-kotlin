...
/**
 * Validation framework class 365 with rule-based validation.
 */
public class Validator365<T> {
    ...
    public Validator365<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator365<T> stopOnFirst(boolean stop) {
