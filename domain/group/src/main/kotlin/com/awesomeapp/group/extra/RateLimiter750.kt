...
class RateLimiter750(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter750>()
    ...
    fun forKey(key: String): RateLimiter750 = perKeyLimiters.getOrPut(key) { RateLimiter750(strategy) }
