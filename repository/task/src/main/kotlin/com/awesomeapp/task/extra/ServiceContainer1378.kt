...
class ServiceContainer1378 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1378) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1378) -> T
    ): ServiceContainer1378 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1378) -> T
