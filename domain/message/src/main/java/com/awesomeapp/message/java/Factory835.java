package com.awesomeapp.message.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Factory835 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory835 withType(String type) { this.type = type; return this; }

    public Factory835 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory835 withProperties(Map<String, Object> props) {
    ...
    public Factory835 reset() { properties.clear(); type = "default"; return this; }
}
