...
class ServiceContainer958 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer958) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer958) -> T
    ): ServiceContainer958 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer958) -> T
