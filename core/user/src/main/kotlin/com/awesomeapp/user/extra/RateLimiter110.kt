...
class RateLimiter110(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter110>()
    ...
    fun forKey(key: String): RateLimiter110 = perKeyLimiters.getOrPut(key) { RateLimiter110(strategy) }
