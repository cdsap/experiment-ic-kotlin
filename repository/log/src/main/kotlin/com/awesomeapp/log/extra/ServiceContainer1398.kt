...
class ServiceContainer1398 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1398) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1398) -> T
    ): ServiceContainer1398 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1398) -> T
