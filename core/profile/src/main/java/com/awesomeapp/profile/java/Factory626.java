...
public class Factory626 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory626 withType(String type) { this.type = type; return this; }

    public Factory626 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory626 withProperties(Map<String, Object> props) {
    ...
    public Factory626 reset() { properties.clear(); type = "default"; return this; }
}
