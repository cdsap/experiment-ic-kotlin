...
class RateLimiter650(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter650>()
    ...
    fun forKey(key: String): RateLimiter650 = perKeyLimiters.getOrPut(key) { RateLimiter650(strategy) }
