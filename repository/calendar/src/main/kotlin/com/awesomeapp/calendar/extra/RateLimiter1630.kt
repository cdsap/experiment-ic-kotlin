...
class RateLimiter1630(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1630>()
    ...
    fun forKey(key: String): RateLimiter1630 = perKeyLimiters.getOrPut(key) { RateLimiter1630(strategy) }
