...
public class Builder652 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder652 withType(String type) { this.type = type; return this; }

    public Builder652 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder652 withProperties(Map<String, Object> props) {
    ...
    public Builder652 reset() { properties.clear(); type = "default"; return this; }
}
