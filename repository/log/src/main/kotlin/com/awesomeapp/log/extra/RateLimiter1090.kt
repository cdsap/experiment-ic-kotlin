...
class RateLimiter1090(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1090>()
    ...
    fun forKey(key: String): RateLimiter1090 = perKeyLimiters.getOrPut(key) { RateLimiter1090(strategy) }
