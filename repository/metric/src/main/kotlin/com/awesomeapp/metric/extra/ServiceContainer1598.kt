...
class ServiceContainer1598 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1598) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1598) -> T
    ): ServiceContainer1598 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1598) -> T
