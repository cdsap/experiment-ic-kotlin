...
class ServiceContainer1458 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1458) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1458) -> T
    ): ServiceContainer1458 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1458) -> T
