...
class RateLimiter870(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter870>()
    ...
    fun forKey(key: String): RateLimiter870 = perKeyLimiters.getOrPut(key) { RateLimiter870(strategy) }
