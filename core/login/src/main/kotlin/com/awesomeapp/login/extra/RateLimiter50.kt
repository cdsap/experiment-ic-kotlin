...
class RateLimiter50(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter50>()
    ...
    fun forKey(key: String): RateLimiter50 = perKeyLimiters.getOrPut(key) { RateLimiter50(strategy) }
