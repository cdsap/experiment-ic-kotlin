...
class ServiceContainer1758 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1758) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1758) -> T
    ): ServiceContainer1758 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1758) -> T
