...
/**
 * Validation framework class 386 with rule-based validation.
 */
public class Validator386<T> {
    ...
    public Validator386<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator386<T> stopOnFirst(boolean stop) {
