...
class RateLimiter1650(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1650>()
    ...
    fun forKey(key: String): RateLimiter1650 = perKeyLimiters.getOrPut(key) { RateLimiter1650(strategy) }
