...
public class Builder438 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder438 withType(String type) { this.type = type; return this; }

    public Builder438 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder438 withProperties(Map<String, Object> props) {
    ...
    public Builder438 reset() { properties.clear(); type = "default"; return this; }
}
