...
class MiddlewareChain928<Req : Any, Res : Any> {
    ...
    fun use(middleware: Middleware<Req, Res>): MiddlewareChain928<Req, Res> {
    ...
    fun onError(handler: suspend (Throwable, Context<Req, Res>) -> Unit): MiddlewareChain928<Req, Res> {
