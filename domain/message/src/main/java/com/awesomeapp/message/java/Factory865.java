...
public class Factory865 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory865 withType(String type) { this.type = type; return this; }

    public Factory865 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory865 withProperties(Map<String, Object> props) {
    ...
    public Factory865 reset() { properties.clear(); type = "default"; return this; }
}
