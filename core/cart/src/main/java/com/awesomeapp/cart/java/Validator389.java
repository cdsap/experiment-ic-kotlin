...
/**
 * Validation framework class 389 with rule-based validation.
 */
public class Validator389<T> {
    ...
    public Validator389<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator389<T> stopOnFirst(boolean stop) {
