...
/**
 * Validation framework class 390 with rule-based validation.
 */
public class Validator390<T> {
    ...
    public Validator390<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator390<T> stopOnFirst(boolean stop) {
