...
class ServiceContainer1678 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1678) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1678) -> T
    ): ServiceContainer1678 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1678) -> T
