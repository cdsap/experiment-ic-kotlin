...
class RateLimiter410(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter410>()
    ...
    fun forKey(key: String): RateLimiter410 = perKeyLimiters.getOrPut(key) { RateLimiter410(strategy) }
