...
class ServiceContainer418 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer418) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer418) -> T
    ): ServiceContainer418 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer418) -> T
