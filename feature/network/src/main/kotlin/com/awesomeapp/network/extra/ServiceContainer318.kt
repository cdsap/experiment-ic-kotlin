...
class ServiceContainer318 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer318) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer318) -> T
    ): ServiceContainer318 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer318) -> T
