...
public class Builder890 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder890 withType(String type) { this.type = type; return this; }

    public Builder890 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder890 withProperties(Map<String, Object> props) {
    ...
    public Builder890 reset() { properties.clear(); type = "default"; return this; }
}
