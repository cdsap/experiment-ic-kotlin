...
public class StateMachine5462<S, E> {
    ...
    public StateMachine5462(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine5462<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine5462<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine5462<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
