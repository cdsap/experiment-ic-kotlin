...
public class StateMachine5122<S, E> {
    ...
    public StateMachine5122(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine5122<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine5122<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine5122<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
