...
public class Factory636 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory636 withType(String type) { this.type = type; return this; }

    public Factory636 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory636 withProperties(Map<String, Object> props) {
    ...
    public Factory636 reset() { properties.clear(); type = "default"; return this; }
}
