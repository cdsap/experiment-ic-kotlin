...
public class Factory267 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory267 withType(String type) { this.type = type; return this; }

    public Factory267 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory267 withProperties(Map<String, Object> props) {
    ...
    public Factory267 reset() { properties.clear(); type = "default"; return this; }
}
