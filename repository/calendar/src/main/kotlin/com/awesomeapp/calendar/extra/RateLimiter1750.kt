...
class RateLimiter1750(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1750>()
    ...
    fun forKey(key: String): RateLimiter1750 = perKeyLimiters.getOrPut(key) { RateLimiter1750(strategy) }
