...
class RateLimiter1730(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1730>()
    ...
    fun forKey(key: String): RateLimiter1730 = perKeyLimiters.getOrPut(key) { RateLimiter1730(strategy) }
