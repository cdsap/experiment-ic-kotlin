...
class ServiceContainer898 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer898) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer898) -> T
    ): ServiceContainer898 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer898) -> T
