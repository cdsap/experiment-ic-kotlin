...
class RateLimiter1530(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1530>()
    ...
    fun forKey(key: String): RateLimiter1530 = perKeyLimiters.getOrPut(key) { RateLimiter1530(strategy) }
