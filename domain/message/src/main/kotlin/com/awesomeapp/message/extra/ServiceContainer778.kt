...
class ServiceContainer778 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer778) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer778) -> T
    ): ServiceContainer778 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer778) -> T
