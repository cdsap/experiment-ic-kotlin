...
class RateLimiter430(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter430>()
    ...
    fun forKey(key: String): RateLimiter430 = perKeyLimiters.getOrPut(key) { RateLimiter430(strategy) }
