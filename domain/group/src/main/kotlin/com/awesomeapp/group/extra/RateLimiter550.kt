...
class RateLimiter550(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter550>()
    ...
    fun forKey(key: String): RateLimiter550 = perKeyLimiters.getOrPut(key) { RateLimiter550(strategy) }
