...
public class Builder697 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder697 withType(String type) { this.type = type; return this; }

    public Builder697 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder697 withProperties(Map<String, Object> props) {
    ...
    public Builder697 reset() { properties.clear(); type = "default"; return this; }
}
