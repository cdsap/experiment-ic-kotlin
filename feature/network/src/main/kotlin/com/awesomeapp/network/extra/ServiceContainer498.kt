...
class ServiceContainer498 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer498) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer498) -> T
    ): ServiceContainer498 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer498) -> T
