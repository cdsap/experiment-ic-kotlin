...
public class StateMachine2482<S, E> {
    ...
    public StateMachine2482(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine2482<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine2482<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine2482<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
