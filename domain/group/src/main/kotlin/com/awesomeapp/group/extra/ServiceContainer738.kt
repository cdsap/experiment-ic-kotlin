...
class ServiceContainer738 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer738) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer738) -> T
    ): ServiceContainer738 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer738) -> T
