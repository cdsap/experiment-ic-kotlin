...
class RateLimiter930(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter930>()
    ...
    fun forKey(key: String): RateLimiter930 = perKeyLimiters.getOrPut(key) { RateLimiter930(strategy) }
