...
class ServiceContainer978 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer978) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer978) -> T
    ): ServiceContainer978 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer978) -> T
