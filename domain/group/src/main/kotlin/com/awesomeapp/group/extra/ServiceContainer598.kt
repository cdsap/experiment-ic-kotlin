...
class ServiceContainer598 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer598) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer598) -> T
    ): ServiceContainer598 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer598) -> T
