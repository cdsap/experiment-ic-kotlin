...
class RateLimiter810(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter810>()
    ...
    fun forKey(key: String): RateLimiter810 = perKeyLimiters.getOrPut(key) { RateLimiter810(strategy) }
