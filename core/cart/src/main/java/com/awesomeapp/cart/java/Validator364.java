...
/**
 * Validation framework class 364 with rule-based validation.
 */
public class Validator364<T> {
    ...
    public Validator364<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator364<T> stopOnFirst(boolean stop) {
