...
class ServiceContainer1238 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1238) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1238) -> T
    ): ServiceContainer1238 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1238) -> T
