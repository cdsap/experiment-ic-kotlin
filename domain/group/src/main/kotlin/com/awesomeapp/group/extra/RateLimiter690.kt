...
class RateLimiter690(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter690>()
    ...
    fun forKey(key: String): RateLimiter690 = perKeyLimiters.getOrPut(key) { RateLimiter690(strategy) }
