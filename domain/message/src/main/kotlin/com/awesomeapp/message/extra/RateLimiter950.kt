...
class RateLimiter950(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter950>()
    ...
    fun forKey(key: String): RateLimiter950 = perKeyLimiters.getOrPut(key) { RateLimiter950(strategy) }
