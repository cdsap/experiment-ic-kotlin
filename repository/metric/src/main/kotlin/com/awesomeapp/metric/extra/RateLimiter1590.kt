...
class RateLimiter1590(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1590>()
    ...
    fun forKey(key: String): RateLimiter1590 = perKeyLimiters.getOrPut(key) { RateLimiter1590(strategy) }
