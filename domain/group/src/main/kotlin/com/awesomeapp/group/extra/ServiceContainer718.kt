...
class ServiceContainer718 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer718) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer718) -> T
    ): ServiceContainer718 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer718) -> T
