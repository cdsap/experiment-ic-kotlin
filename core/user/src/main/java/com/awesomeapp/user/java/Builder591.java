...
public class Builder591 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder591 withType(String type) { this.type = type; return this; }

    public Builder591 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder591 withProperties(Map<String, Object> props) {
    ...
    public Builder591 reset() { properties.clear(); type = "default"; return this; }
}
