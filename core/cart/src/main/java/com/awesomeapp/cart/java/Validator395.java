...
/**
 * Validation framework class 395 with rule-based validation.
 */
public class Validator395<T> {
    ...
    public Validator395<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator395<T> stopOnFirst(boolean stop) {
