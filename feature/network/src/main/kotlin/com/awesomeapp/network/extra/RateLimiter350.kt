...
class RateLimiter350(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter350>()
    ...
    fun forKey(key: String): RateLimiter350 = perKeyLimiters.getOrPut(key) { RateLimiter350(strategy) }
