...
public class StateMachine5682<S, E> {
    ...
    public StateMachine5682(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine5682<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine5682<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine5682<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
