...
/**
 * Validation framework class 356 with rule-based validation.
 */
public class Validator356<T> {
    ...
    public Validator356<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator356<T> stopOnFirst(boolean stop) {
