...
/**
 * Validation framework class 360 with rule-based validation.
 */
public class Validator360<T> {
    ...
    public Validator360<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator360<T> stopOnFirst(boolean stop) {
