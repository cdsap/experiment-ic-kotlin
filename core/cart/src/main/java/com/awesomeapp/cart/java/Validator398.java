...
/**
 * Validation framework class 398 with rule-based validation.
 */
public class Validator398<T> {
    ...
    public Validator398<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator398<T> stopOnFirst(boolean stop) {
