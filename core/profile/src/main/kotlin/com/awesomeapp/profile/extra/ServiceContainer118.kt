...
class ServiceContainer118 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer118) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer118) -> T
    ): ServiceContainer118 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer118) -> T
