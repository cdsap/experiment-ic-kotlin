...
public class Factory889 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory889 withType(String type) { this.type = type; return this; }

    public Factory889 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory889 withProperties(Map<String, Object> props) {
    ...
    public Factory889 reset() { properties.clear(); type = "default"; return this; }
}
