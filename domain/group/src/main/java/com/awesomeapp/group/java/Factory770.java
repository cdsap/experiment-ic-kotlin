package com.awesomeapp.group.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Factory770 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory770 withType(String type) { this.type = type; return this; }

    public Factory770 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory770 withProperties(Map<String, Object> props) {
    ...
    public Factory770 reset() { properties.clear(); type = "default"; return this; }
}
