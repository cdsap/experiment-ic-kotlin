...
class ServiceContainer138 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer138) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer138) -> T
    ): ServiceContainer138 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer138) -> T
