...
/**
 * Validation framework class 380 with rule-based validation.
 */
public class Validator380<T> {
    ...
    public Validator380<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator380<T> stopOnFirst(boolean stop) {
