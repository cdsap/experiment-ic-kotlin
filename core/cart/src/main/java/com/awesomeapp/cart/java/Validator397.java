...
/**
 * Validation framework class 397 with rule-based validation.
 */
public class Validator397<T> {
    ...
    public Validator397<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator397<T> stopOnFirst(boolean stop) {
