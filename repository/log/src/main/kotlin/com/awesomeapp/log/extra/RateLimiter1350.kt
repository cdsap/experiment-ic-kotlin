...
class RateLimiter1350(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1350>()
    ...
    fun forKey(key: String): RateLimiter1350 = perKeyLimiters.getOrPut(key) { RateLimiter1350(strategy) }
