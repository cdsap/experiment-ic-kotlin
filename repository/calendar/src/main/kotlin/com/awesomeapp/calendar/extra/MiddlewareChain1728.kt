...
class MiddlewareChain1728<Req : Any, Res : Any> {
    ...
    fun use(middleware: Middleware<Req, Res>): MiddlewareChain1728<Req, Res> {
    ...
    fun onError(handler: suspend (Throwable, Context<Req, Res>) -> Unit): MiddlewareChain1728<Req, Res> {
