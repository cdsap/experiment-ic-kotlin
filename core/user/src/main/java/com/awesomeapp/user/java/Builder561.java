...
public class Builder561 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder561 withType(String type) { this.type = type; return this; }

    public Builder561 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder561 withProperties(Map<String, Object> props) {
    ...
    public Builder561 reset() { properties.clear(); type = "default"; return this; }
}
