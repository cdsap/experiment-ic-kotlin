...
class RateLimiter90(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter90>()
    ...
    fun forKey(key: String): RateLimiter90 = perKeyLimiters.getOrPut(key) { RateLimiter90(strategy) }
