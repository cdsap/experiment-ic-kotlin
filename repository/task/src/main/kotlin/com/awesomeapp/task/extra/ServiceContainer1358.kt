...
class ServiceContainer1358 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1358) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1358) -> T
    ): ServiceContainer1358 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1358) -> T
