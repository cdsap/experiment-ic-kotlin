...
public class Builder611 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder611 withType(String type) { this.type = type; return this; }

    public Builder611 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder611 withProperties(Map<String, Object> props) {
    ...
    public Builder611 reset() { properties.clear(); type = "default"; return this; }
}
