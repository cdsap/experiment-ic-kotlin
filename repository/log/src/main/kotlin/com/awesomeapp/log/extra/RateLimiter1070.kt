...
class RateLimiter1070(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1070>()
    ...
    fun forKey(key: String): RateLimiter1070 = perKeyLimiters.getOrPut(key) { RateLimiter1070(strategy) }
