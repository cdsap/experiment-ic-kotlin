...
class ServiceContainer858 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer858) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer858) -> T
    ): ServiceContainer858 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer858) -> T
