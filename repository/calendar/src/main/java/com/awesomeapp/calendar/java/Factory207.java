package com.awesomeapp.calendar.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Factory207 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory207 withType(String type) { this.type = type; return this; }

    public Factory207 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory207 withProperties(Map<String, Object> props) {
    ...
    public Factory207 reset() { properties.clear(); type = "default"; return this; }
}
