...
class RateLimiter1050(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1050>()
    ...
    fun forKey(key: String): RateLimiter1050 = perKeyLimiters.getOrPut(key) { RateLimiter1050(strategy) }
