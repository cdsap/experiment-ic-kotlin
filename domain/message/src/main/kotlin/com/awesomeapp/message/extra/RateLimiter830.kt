...
class RateLimiter830(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter830>()
    ...
    fun forKey(key: String): RateLimiter830 = perKeyLimiters.getOrPut(key) { RateLimiter830(strategy) }
