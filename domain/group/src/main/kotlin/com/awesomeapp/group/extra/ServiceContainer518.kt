...
class ServiceContainer518 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer518) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer518) -> T
    ): ServiceContainer518 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer518) -> T
