...
public class Factory560 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory560 withType(String type) { this.type = type; return this; }

    public Factory560 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory560 withProperties(Map<String, Object> props) {
    ...
    public Factory560 reset() { properties.clear(); type = "default"; return this; }
}
