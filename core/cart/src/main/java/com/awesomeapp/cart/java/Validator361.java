...
/**
 * Validation framework class 361 with rule-based validation.
 */
public class Validator361<T> {
    ...
    public Validator361<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator361<T> stopOnFirst(boolean stop) {
