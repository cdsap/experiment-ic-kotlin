...
/**
 * Validation framework class 391 with rule-based validation.
 */
public class Validator391<T> {
    ...
    public Validator391<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator391<T> stopOnFirst(boolean stop) {
