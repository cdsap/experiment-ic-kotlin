...
public class Factory570 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory570 withType(String type) { this.type = type; return this; }

    public Factory570 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory570 withProperties(Map<String, Object> props) {
    ...
    public Factory570 reset() { properties.clear(); type = "default"; return this; }
}
