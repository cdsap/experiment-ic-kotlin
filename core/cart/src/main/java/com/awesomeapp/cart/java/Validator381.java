...
/**
 * Validation framework class 381 with rule-based validation.
 */
public class Validator381<T> {
    ...
    public Validator381<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator381<T> stopOnFirst(boolean stop) {
