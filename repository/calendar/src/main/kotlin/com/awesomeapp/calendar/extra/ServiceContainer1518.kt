...
class ServiceContainer1518 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1518) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1518) -> T
    ): ServiceContainer1518 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1518) -> T
