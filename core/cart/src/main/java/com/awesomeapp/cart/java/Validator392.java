...
/**
 * Validation framework class 392 with rule-based validation.
 */
public class Validator392<T> {
    ...
    public Validator392<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator392<T> stopOnFirst(boolean stop) {
