package com.awesomeapp.list.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Builder751 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder751 withType(String type) { this.type = type; return this; }

    public Builder751 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder751 withProperties(Map<String, Object> props) {
    ...
    public Builder751 reset() { properties.clear(); type = "default"; return this; }
}
