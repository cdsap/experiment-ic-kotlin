...
class RateLimiter730(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter730>()
    ...
    fun forKey(key: String): RateLimiter730 = perKeyLimiters.getOrPut(key) { RateLimiter730(strategy) }
