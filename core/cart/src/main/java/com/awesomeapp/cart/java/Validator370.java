...
/**
 * Validation framework class 370 with rule-based validation.
 */
public class Validator370<T> {
    ...
    public Validator370<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator370<T> stopOnFirst(boolean stop) {
