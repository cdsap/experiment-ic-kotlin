...
class RateLimiter1450(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1450>()
    ...
    fun forKey(key: String): RateLimiter1450 = perKeyLimiters.getOrPut(key) { RateLimiter1450(strategy) }
