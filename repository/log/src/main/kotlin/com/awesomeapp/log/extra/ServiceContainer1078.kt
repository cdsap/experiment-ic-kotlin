...
class ServiceContainer1078 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1078) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1078) -> T
    ): ServiceContainer1078 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1078) -> T
