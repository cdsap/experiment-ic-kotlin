...
class QueryBuilder712 {
    ...
    sealed class Expression {
        ...
        data class SubQuery(val query: QueryBuilder712) : Expression()
    }
    ...
    sealed class Condition {
        ...
        data class Exists(val subQuery: QueryBuilder712) : Condition()
    ...
    fun from(table: String, alias: String? = null): QueryBuilder712 {
        this.table = table; this.tableAlias = alias; return this
    }

    fun select(vararg fields: String): QueryBuilder712 {
        fields.forEach { selectFields.add(Expression.Field(it) to null) }; return this
    }

    fun selectAs(field: String, alias: String): QueryBuilder712 {
        selectFields.add(Expression.Field(field) to alias); return this
    }

    fun selectExpr(expr: Expression, alias: String? = null): QueryBuilder712 {
        selectFields.add(expr to alias); return this
    }

    fun distinct(): QueryBuilder712 { distinct = true; return this }

    fun where(condition: Condition): QueryBuilder712 { conditions.add(condition); return this }
    fun whereEq(field: String, value: Any?): QueryBuilder712 { conditions.add(Condition.Comparison(field, CompOp.EQ, value)); return this }
    fun whereGt(field: String, value: Any): QueryBuilder712 { conditions.add(Condition.Comparison(field, CompOp.GT, value)); return this }
    fun whereLt(field: String, value: Any): QueryBuilder712 { conditions.add(Condition.Comparison(field, CompOp.LT, value)); return this }
    fun whereBetween(field: String, low: Any, high: Any): QueryBuilder712 { conditions.add(Condition.Between(field, low, high)); return this }
    fun whereIn(field: String, values: List<Any>): QueryBuilder712 { conditions.add(Condition.In(field, values)); return this }
    fun whereNull(field: String): QueryBuilder712 { conditions.add(Condition.IsNull(field)); return this }
    fun whereNotNull(field: String): QueryBuilder712 { conditions.add(Condition.IsNotNull(field)); return this }
    fun whereLike(field: String, pattern: String): QueryBuilder712 { conditions.add(Condition.Like(field, pattern)); return this }
    fun whereNot(condition: Condition): QueryBuilder712 { conditions.add(Condition.Not(condition)); return this }
    fun whereExists(subQuery: QueryBuilder712): QueryBuilder712 { conditions.add(Condition.Exists(subQuery)); return this }

    fun join(table: String, on: Condition, type: JoinType = JoinType.INNER, alias: String? = null): QueryBuilder712 {
    ...
    fun orderBy(field: String, direction: OrderDir = OrderDir.ASC): QueryBuilder712 {
        orderBys.add(OrderBy(field, direction)); return this
    }

    fun groupBy(vararg fields: String, having: Condition? = null): QueryBuilder712 {
        groupBy = GroupBy(fields.toList(), having); return this
    }

    fun limit(limit: Int): QueryBuilder712 { limitValue = limit; return this }
    fun offset(offset: Int): QueryBuilder712 { offsetValue = offset; return this }
