...
class RateLimiter1430(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1430>()
    ...
    fun forKey(key: String): RateLimiter1430 = perKeyLimiters.getOrPut(key) { RateLimiter1430(strategy) }
