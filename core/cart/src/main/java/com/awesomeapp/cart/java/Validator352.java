...
/**
 * Validation framework class 352 with rule-based validation.
 */
public class Validator352<T> {
    ...
    public Validator352<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator352<T> stopOnFirst(boolean stop) {
