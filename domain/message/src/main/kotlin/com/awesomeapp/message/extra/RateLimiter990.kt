...
class RateLimiter990(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter990>()
    ...
    fun forKey(key: String): RateLimiter990 = perKeyLimiters.getOrPut(key) { RateLimiter990(strategy) }
