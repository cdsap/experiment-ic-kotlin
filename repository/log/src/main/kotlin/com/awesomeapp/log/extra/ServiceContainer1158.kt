...
class ServiceContainer1158 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1158) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1158) -> T
    ): ServiceContainer1158 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1158) -> T
