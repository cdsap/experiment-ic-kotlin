...
public class Factory357 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory357 withType(String type) { this.type = type; return this; }

    public Factory357 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory357 withProperties(Map<String, Object> props) {
    ...
    public Factory357 reset() { properties.clear(); type = "default"; return this; }
}
