...
public class Builder791 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder791 withType(String type) { this.type = type; return this; }

    public Builder791 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder791 withProperties(Map<String, Object> props) {
    ...
    public Builder791 reset() { properties.clear(); type = "default"; return this; }
}
