...
public class Builder601 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder601 withType(String type) { this.type = type; return this; }

    public Builder601 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder601 withProperties(Map<String, Object> props) {
    ...
    public Builder601 reset() { properties.clear(); type = "default"; return this; }
}
