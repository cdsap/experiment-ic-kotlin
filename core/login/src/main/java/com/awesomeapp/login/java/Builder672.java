...
public class Builder672 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder672 withType(String type) { this.type = type; return this; }

    public Builder672 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder672 withProperties(Map<String, Object> props) {
    ...
    public Builder672 reset() { properties.clear(); type = "default"; return this; }
}
