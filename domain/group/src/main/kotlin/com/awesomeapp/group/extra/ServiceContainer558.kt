...
class ServiceContainer558 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer558) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer558) -> T
    ): ServiceContainer558 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer558) -> T
