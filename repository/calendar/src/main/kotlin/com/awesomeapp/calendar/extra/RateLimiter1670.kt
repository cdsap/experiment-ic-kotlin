...
class RateLimiter1670(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1670>()
    ...
    fun forKey(key: String): RateLimiter1670 = perKeyLimiters.getOrPut(key) { RateLimiter1670(strategy) }
