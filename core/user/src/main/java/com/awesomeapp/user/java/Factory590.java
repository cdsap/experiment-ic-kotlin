...
public class Factory590 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory590 withType(String type) { this.type = type; return this; }

    public Factory590 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory590 withProperties(Map<String, Object> props) {
    ...
    public Factory590 reset() { properties.clear(); type = "default"; return this; }
}
