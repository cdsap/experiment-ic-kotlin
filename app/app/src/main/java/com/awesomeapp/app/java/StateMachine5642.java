...
public class StateMachine5642<S, E> {
    ...
    public StateMachine5642(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine5642<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine5642<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine5642<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
