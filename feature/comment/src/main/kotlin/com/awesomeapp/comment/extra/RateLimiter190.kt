...
class RateLimiter190(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter190>()
    ...
    fun forKey(key: String): RateLimiter190 = perKeyLimiters.getOrPut(key) { RateLimiter190(strategy) }
