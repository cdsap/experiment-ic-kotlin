...
class ServiceContainer1318 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1318) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1318) -> T
    ): ServiceContainer1318 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1318) -> T
