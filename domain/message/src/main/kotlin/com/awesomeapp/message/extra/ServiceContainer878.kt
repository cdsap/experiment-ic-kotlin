...
class ServiceContainer878 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer878) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer878) -> T
    ): ServiceContainer878 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer878) -> T
