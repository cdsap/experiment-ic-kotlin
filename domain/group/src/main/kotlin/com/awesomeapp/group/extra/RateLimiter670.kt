...
class RateLimiter670(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter670>()
    ...
    fun forKey(key: String): RateLimiter670 = perKeyLimiters.getOrPut(key) { RateLimiter670(strategy) }
