...
/**
 * Validation framework class 379 with rule-based validation.
 */
public class Validator379<T> {
    ...
    public Validator379<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator379<T> stopOnFirst(boolean stop) {
