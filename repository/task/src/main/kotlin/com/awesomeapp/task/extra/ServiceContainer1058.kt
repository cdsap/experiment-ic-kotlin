...
class ServiceContainer1058 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1058) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1058) -> T
    ): ServiceContainer1058 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1058) -> T
