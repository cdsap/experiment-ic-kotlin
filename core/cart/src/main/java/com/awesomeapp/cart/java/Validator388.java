...
/**
 * Validation framework class 388 with rule-based validation.
 */
public class Validator388<T> {
    ...
    public Validator388<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator388<T> stopOnFirst(boolean stop) {
