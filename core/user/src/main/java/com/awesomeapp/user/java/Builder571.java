...
public class Builder571 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder571 withType(String type) { this.type = type; return this; }

    public Builder571 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder571 withProperties(Map<String, Object> props) {
    ...
    public Builder571 reset() { properties.clear(); type = "default"; return this; }
}
