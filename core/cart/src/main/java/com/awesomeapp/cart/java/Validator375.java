...
/**
 * Validation framework class 375 with rule-based validation.
 */
public class Validator375<T> {
    ...
    public Validator375<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator375<T> stopOnFirst(boolean stop) {
