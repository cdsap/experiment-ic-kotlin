...
class RateLimiter450(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter450>()
    ...
    fun forKey(key: String): RateLimiter450 = perKeyLimiters.getOrPut(key) { RateLimiter450(strategy) }
