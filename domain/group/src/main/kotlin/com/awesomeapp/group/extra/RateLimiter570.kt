...
class RateLimiter570(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter570>()
    ...
    fun forKey(key: String): RateLimiter570 = perKeyLimiters.getOrPut(key) { RateLimiter570(strategy) }
