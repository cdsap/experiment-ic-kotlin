...
public class StateMachine2262<S, E> {
    ...
    public StateMachine2262(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine2262<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine2262<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine2262<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
