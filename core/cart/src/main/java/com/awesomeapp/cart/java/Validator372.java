...
/**
 * Validation framework class 372 with rule-based validation.
 */
public class Validator372<T> {
    ...
    public Validator372<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator372<T> stopOnFirst(boolean stop) {
