...
class RateLimiter770(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter770>()
    ...
    fun forKey(key: String): RateLimiter770 = perKeyLimiters.getOrPut(key) { RateLimiter770(strategy) }
