...
public class DataModel6 {
    ...
    public DataModel6(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel6{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
