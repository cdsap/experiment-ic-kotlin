...
class RateLimiter1510(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1510>()
    ...
    fun forKey(key: String): RateLimiter1510 = perKeyLimiters.getOrPut(key) { RateLimiter1510(strategy) }
