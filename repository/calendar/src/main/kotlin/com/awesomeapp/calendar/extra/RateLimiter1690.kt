...
class RateLimiter1690(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1690>()
    ...
    fun forKey(key: String): RateLimiter1690 = perKeyLimiters.getOrPut(key) { RateLimiter1690(strategy) }
