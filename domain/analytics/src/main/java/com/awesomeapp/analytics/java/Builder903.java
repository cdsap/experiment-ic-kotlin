package com.awesomeapp.analytics.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Builder903 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder903 withType(String type) { this.type = type; return this; }

    public Builder903 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder903 withProperties(Map<String, Object> props) {
    ...
    public Builder903 reset() { properties.clear(); type = "default"; return this; }
}
