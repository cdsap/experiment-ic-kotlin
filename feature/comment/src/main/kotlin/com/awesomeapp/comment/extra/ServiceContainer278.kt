...
class ServiceContainer278 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer278) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer278) -> T
    ): ServiceContainer278 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer278) -> T
