...
public class QueryBuilder5476 {
    ...
    public QueryBuilder5476 select(String... columns) {
        for (String c : columns) selectColumns.add(new Column(null, c, null));
        return this;
    }

    public QueryBuilder5476 select(String table, String column, String alias) {
        selectColumns.add(new Column(table, column, alias));
        return this;
    }

    public QueryBuilder5476 selectAggregate(AggregateFunction fn, String column, String alias) {
        selectColumns.add(new Column(null, fn.name() + "(" + column + ")", alias));
        return this;
    }

    public QueryBuilder5476 distinct() { this.distinct = true; return this; }

    public QueryBuilder5476 from(String table) { this.fromTable = table; return this; }

    public QueryBuilder5476 from(String table, String alias) {
        this.fromTable = table; this.fromAlias = alias; return this;
    }

    public QueryBuilder5476 join(JoinType type, String table, String onCondition) {
        joins.add(type.name().replace('_', ' ') + " JOIN " + table + " ON " + onCondition);
        return this;
    }

    public QueryBuilder5476 where(String expression, Object... params) {
        whereConditions.add(new Condition(expression, params));
        return this;
    }

    public QueryBuilder5476 groupBy(String... columns) {
        groupByColumns.addAll(Arrays.asList(columns));
        return this;
    }

    public QueryBuilder5476 having(String expression, Object... params) {
        havingConditions.add(new Condition(expression, params));
        return this;
    }

    public QueryBuilder5476 orderBy(String column, SortDirection dir) {
        orderByColumns.add(column + " " + dir.name());
        return this;
    }

    public QueryBuilder5476 limit(int limit) { this.limit = limit; return this; }
    public QueryBuilder5476 offset(int offset) { this.offset = offset; return this; }
