...
/**
 * Validation framework class 359 with rule-based validation.
 */
public class Validator359<T> {
    ...
    public Validator359<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator359<T> stopOnFirst(boolean stop) {
