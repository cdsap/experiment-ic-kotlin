...
class RateLimiter490(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter490>()
    ...
    fun forKey(key: String): RateLimiter490 = perKeyLimiters.getOrPut(key) { RateLimiter490(strategy) }
