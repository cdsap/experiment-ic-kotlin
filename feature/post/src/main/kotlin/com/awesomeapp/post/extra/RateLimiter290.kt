...
class RateLimiter290(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter290>()
    ...
    fun forKey(key: String): RateLimiter290 = perKeyLimiters.getOrPut(key) { RateLimiter290(strategy) }
