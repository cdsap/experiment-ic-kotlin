...
class ServiceContainer98 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer98) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer98) -> T
    ): ServiceContainer98 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer98) -> T
