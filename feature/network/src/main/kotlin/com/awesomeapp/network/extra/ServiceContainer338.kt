...
class ServiceContainer338 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer338) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer338) -> T
    ): ServiceContainer338 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer338) -> T
