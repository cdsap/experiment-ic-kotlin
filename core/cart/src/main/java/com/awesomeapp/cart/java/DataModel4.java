...
public class DataModel4 {
    ...
    public DataModel4(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel4{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
