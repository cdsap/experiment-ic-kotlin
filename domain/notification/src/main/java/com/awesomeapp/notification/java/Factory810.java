...
public class Factory810 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory810 withType(String type) { this.type = type; return this; }

    public Factory810 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory810 withProperties(Map<String, Object> props) {
    ...
    public Factory810 reset() { properties.clear(); type = "default"; return this; }
}
