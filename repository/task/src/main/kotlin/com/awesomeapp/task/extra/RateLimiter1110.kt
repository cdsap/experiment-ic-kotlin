...
class RateLimiter1110(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1110>()
    ...
    fun forKey(key: String): RateLimiter1110 = perKeyLimiters.getOrPut(key) { RateLimiter1110(strategy) }
