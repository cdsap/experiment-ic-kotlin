...
class ServiceContainer758 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer758) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer758) -> T
    ): ServiceContainer758 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer758) -> T
