...
/**
 * Validation framework class 382 with rule-based validation.
 */
public class Validator382<T> {
    ...
    public Validator382<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator382<T> stopOnFirst(boolean stop) {
