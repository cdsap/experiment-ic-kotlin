...
class RateLimiter1210(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1210>()
    ...
    fun forKey(key: String): RateLimiter1210 = perKeyLimiters.getOrPut(key) { RateLimiter1210(strategy) }
