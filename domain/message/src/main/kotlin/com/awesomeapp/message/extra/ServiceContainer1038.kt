...
class ServiceContainer1038 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1038) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1038) -> T
    ): ServiceContainer1038 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1038) -> T
