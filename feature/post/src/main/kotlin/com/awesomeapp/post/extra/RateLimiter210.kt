...
class RateLimiter210(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter210>()
    ...
    fun forKey(key: String): RateLimiter210 = perKeyLimiters.getOrPut(key) { RateLimiter210(strategy) }
