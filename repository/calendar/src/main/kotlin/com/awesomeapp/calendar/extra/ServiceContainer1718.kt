...
class ServiceContainer1718 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1718) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1718) -> T
    ): ServiceContainer1718 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1718) -> T
