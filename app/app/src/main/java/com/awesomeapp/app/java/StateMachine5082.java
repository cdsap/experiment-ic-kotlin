...
public class StateMachine5082<S, E> {
    ...
    public StateMachine5082(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine5082<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine5082<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine5082<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
