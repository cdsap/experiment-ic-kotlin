...
class ServiceContainer198 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer198) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer198) -> T
    ): ServiceContainer198 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer198) -> T
