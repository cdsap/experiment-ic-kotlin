...
public class Factory661 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory661 withType(String type) { this.type = type; return this; }

    public Factory661 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory661 withProperties(Map<String, Object> props) {
    ...
    public Factory661 reset() { properties.clear(); type = "default"; return this; }
}
