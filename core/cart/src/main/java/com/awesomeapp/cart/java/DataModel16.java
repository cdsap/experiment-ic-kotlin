...
public class DataModel16 {
    ...
    public DataModel16(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel16{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
    ...
    public boolean equals(Object o) {
        ...
        DataModel16 that = (DataModel16) o;
