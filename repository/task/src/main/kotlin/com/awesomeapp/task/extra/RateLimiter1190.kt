...
class RateLimiter1190(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1190>()
    ...
    fun forKey(key: String): RateLimiter1190 = perKeyLimiters.getOrPut(key) { RateLimiter1190(strategy) }
