...
class ServiceContainer78 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer78) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer78) -> T
    ): ServiceContainer78 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer78) -> T
