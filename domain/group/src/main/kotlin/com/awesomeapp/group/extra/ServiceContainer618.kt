...
class ServiceContainer618 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer618) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer618) -> T
    ): ServiceContainer618 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer618) -> T
