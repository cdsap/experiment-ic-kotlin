...
public class Builder581 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder581 withType(String type) { this.type = type; return this; }

    public Builder581 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder581 withProperties(Map<String, Object> props) {
    ...
    public Builder581 reset() { properties.clear(); type = "default"; return this; }
}
