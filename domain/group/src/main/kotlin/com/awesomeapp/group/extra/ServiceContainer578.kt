...
class ServiceContainer578 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer578) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer578) -> T
    ): ServiceContainer578 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer578) -> T
