...
class ServiceContainer818 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer818) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer818) -> T
    ): ServiceContainer818 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer818) -> T
