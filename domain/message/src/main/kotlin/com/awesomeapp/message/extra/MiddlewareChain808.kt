...
class MiddlewareChain808<Req : Any, Res : Any> {
    ...
    fun use(middleware: Middleware<Req, Res>): MiddlewareChain808<Req, Res> {
    ...
    fun onError(handler: suspend (Throwable, Context<Req, Res>) -> Unit): MiddlewareChain808<Req, Res> {
