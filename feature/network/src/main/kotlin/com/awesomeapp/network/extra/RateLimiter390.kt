...
class RateLimiter390(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter390>()
    ...
    fun forKey(key: String): RateLimiter390 = perKeyLimiters.getOrPut(key) { RateLimiter390(strategy) }
