...
class ServiceContainer358 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer358) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer358) -> T
    ): ServiceContainer358 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer358) -> T
