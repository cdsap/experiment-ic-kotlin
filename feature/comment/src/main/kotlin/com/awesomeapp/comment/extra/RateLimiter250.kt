...
class RateLimiter250(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter250>()
    ...
    fun forKey(key: String): RateLimiter250 = perKeyLimiters.getOrPut(key) { RateLimiter250(strategy) }
