...
class RateLimiter1490(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1490>()
    ...
    fun forKey(key: String): RateLimiter1490 = perKeyLimiters.getOrPut(key) { RateLimiter1490(strategy) }
