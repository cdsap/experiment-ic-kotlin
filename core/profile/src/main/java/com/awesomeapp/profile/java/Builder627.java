...
public class Builder627 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder627 withType(String type) { this.type = type; return this; }

    public Builder627 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder627 withProperties(Map<String, Object> props) {
    ...
    public Builder627 reset() { properties.clear(); type = "default"; return this; }
}
