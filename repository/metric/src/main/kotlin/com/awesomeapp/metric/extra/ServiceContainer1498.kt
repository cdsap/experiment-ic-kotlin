...
class ServiceContainer1498 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1498) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1498) -> T
    ): ServiceContainer1498 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1498) -> T
