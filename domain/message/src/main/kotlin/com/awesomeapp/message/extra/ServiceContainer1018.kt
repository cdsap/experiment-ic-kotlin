...
class ServiceContainer1018 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1018) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1018) -> T
    ): ServiceContainer1018 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1018) -> T
