...
public class Factory497 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory497 withType(String type) { this.type = type; return this; }

    public Factory497 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory497 withProperties(Map<String, Object> props) {
    ...
    public Factory497 reset() { properties.clear(); type = "default"; return this; }
}
