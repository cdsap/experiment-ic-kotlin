...
/**
 * Validation framework class 357 with rule-based validation.
 */
public class Validator357<T> {
    ...
    public Validator357<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator357<T> stopOnFirst(boolean stop) {
