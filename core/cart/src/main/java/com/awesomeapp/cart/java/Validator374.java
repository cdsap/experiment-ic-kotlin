...
/**
 * Validation framework class 374 with rule-based validation.
 */
public class Validator374<T> {
    ...
    public Validator374<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator374<T> stopOnFirst(boolean stop) {
