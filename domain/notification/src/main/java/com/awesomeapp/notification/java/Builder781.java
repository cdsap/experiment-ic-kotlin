package com.awesomeapp.notification.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Builder781 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder781 withType(String type) { this.type = type; return this; }

    public Builder781 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder781 withProperties(Map<String, Object> props) {
    ...
    public Builder781 reset() { properties.clear(); type = "default"; return this; }
}
