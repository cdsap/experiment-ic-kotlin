...
class ServiceContainer58 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer58) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer58) -> T
    ): ServiceContainer58 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer58) -> T
