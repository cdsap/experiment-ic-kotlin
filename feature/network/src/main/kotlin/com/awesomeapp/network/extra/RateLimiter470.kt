...
class RateLimiter470(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter470>()
    ...
    fun forKey(key: String): RateLimiter470 = perKeyLimiters.getOrPut(key) { RateLimiter470(strategy) }
