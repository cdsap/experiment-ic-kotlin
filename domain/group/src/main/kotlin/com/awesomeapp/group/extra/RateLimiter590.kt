...
class RateLimiter590(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter590>()
    ...
    fun forKey(key: String): RateLimiter590 = perKeyLimiters.getOrPut(key) { RateLimiter590(strategy) }
