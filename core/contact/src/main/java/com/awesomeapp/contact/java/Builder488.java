...
public class Builder488 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder488 withType(String type) { this.type = type; return this; }

    public Builder488 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder488 withProperties(Map<String, Object> props) {
    ...
    public Builder488 reset() { properties.clear(); type = "default"; return this; }
}
