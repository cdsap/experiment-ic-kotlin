...
class QueryBuilder912 {
    ...
    sealed class Expression {
        ...
        data class SubQuery(val query: QueryBuilder912) : Expression()
    }
    ...
    sealed class Condition {
        ...
        data class Exists(val subQuery: QueryBuilder912) : Condition()
    ...
    fun from(table: String, alias: String? = null): QueryBuilder912 {
        this.table = table; this.tableAlias = alias; return this
    }

    fun select(vararg fields: String): QueryBuilder912 {
        fields.forEach { selectFields.add(Expression.Field(it) to null) }; return this
    }

    fun selectAs(field: String, alias: String): QueryBuilder912 {
        selectFields.add(Expression.Field(field) to alias); return this
    }

    fun selectExpr(expr: Expression, alias: String? = null): QueryBuilder912 {
        selectFields.add(expr to alias); return this
    }

    fun distinct(): QueryBuilder912 { distinct = true; return this }

    fun where(condition: Condition): QueryBuilder912 { conditions.add(condition); return this }
    fun whereEq(field: String, value: Any?): QueryBuilder912 { conditions.add(Condition.Comparison(field, CompOp.EQ, value)); return this }
    fun whereGt(field: String, value: Any): QueryBuilder912 { conditions.add(Condition.Comparison(field, CompOp.GT, value)); return this }
    fun whereLt(field: String, value: Any): QueryBuilder912 { conditions.add(Condition.Comparison(field, CompOp.LT, value)); return this }
    fun whereBetween(field: String, low: Any, high: Any): QueryBuilder912 { conditions.add(Condition.Between(field, low, high)); return this }
    fun whereIn(field: String, values: List<Any>): QueryBuilder912 { conditions.add(Condition.In(field, values)); return this }
    fun whereNull(field: String): QueryBuilder912 { conditions.add(Condition.IsNull(field)); return this }
    fun whereNotNull(field: String): QueryBuilder912 { conditions.add(Condition.IsNotNull(field)); return this }
    fun whereLike(field: String, pattern: String): QueryBuilder912 { conditions.add(Condition.Like(field, pattern)); return this }
    fun whereNot(condition: Condition): QueryBuilder912 { conditions.add(Condition.Not(condition)); return this }
    fun whereExists(subQuery: QueryBuilder912): QueryBuilder912 { conditions.add(Condition.Exists(subQuery)); return this }

    fun join(table: String, on: Condition, type: JoinType = JoinType.INNER, alias: String? = null): QueryBuilder912 {
    ...
    fun orderBy(field: String, direction: OrderDir = OrderDir.ASC): QueryBuilder912 {
        orderBys.add(OrderBy(field, direction)); return this
    }

    fun groupBy(vararg fields: String, having: Condition? = null): QueryBuilder912 {
        groupBy = GroupBy(fields.toList(), having); return this
    }

    fun limit(limit: Int): QueryBuilder912 { limitValue = limit; return this }
    fun offset(offset: Int): QueryBuilder912 { offsetValue = offset; return this }
