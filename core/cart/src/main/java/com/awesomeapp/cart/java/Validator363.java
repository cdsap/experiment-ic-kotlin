...
/**
 * Validation framework class 363 with rule-based validation.
 */
public class Validator363<T> {
    ...
    public Validator363<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator363<T> stopOnFirst(boolean stop) {
