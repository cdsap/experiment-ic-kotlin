...
class ServiceContainer678 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer678) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer678) -> T
    ): ServiceContainer678 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer678) -> T
