...
class RateLimiter1610(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1610>()
    ...
    fun forKey(key: String): RateLimiter1610 = perKeyLimiters.getOrPut(key) { RateLimiter1610(strategy) }
