...
public class Factory467 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory467 withType(String type) { this.type = type; return this; }

    public Factory467 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory467 withProperties(Map<String, Object> props) {
    ...
    public Factory467 reset() { properties.clear(); type = "default"; return this; }
}
