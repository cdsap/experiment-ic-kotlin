...
/**
 * Validation framework class 396 with rule-based validation.
 */
public class Validator396<T> {
    ...
    public Validator396<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator396<T> stopOnFirst(boolean stop) {
