...
public class Factory651 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory651 withType(String type) { this.type = type; return this; }

    public Factory651 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory651 withProperties(Map<String, Object> props) {
    ...
    public Factory651 reset() { properties.clear(); type = "default"; return this; }
}
