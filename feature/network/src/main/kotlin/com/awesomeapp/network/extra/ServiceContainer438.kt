...
class ServiceContainer438 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer438) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer438) -> T
    ): ServiceContainer438 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer438) -> T
