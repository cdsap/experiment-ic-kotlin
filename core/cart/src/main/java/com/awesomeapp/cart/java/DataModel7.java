...
/**
 * Simple data model class 7.
 */
public class DataModel7 {
    private String id;
    private String name;
    private int value;
    ...
    public DataModel7(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel7{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
