...
public class Builder208 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder208 withType(String type) { this.type = type; return this; }

    public Builder208 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder208 withProperties(Map<String, Object> props) {
    ...
    public Builder208 reset() { properties.clear(); type = "default"; return this; }
}
