...
public class Builder801 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder801 withType(String type) { this.type = type; return this; }

    public Builder801 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder801 withProperties(Map<String, Object> props) {
    ...
    public Builder801 reset() { properties.clear(); type = "default"; return this; }
}
