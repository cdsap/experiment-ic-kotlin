...
class ServiceContainer938 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer938) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer938) -> T
    ): ServiceContainer938 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer938) -> T
