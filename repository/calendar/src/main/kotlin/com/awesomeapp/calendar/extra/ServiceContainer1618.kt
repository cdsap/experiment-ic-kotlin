...
class ServiceContainer1618 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1618) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1618) -> T
    ): ServiceContainer1618 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1618) -> T
