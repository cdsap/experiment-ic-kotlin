...
class RateLimiter1130(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1130>()
    ...
    fun forKey(key: String): RateLimiter1130 = perKeyLimiters.getOrPut(key) { RateLimiter1130(strategy) }
