...
class ServiceContainer998 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer998) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer998) -> T
    ): ServiceContainer998 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer998) -> T
