...
class RateLimiter1250(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1250>()
    ...
    fun forKey(key: String): RateLimiter1250 = perKeyLimiters.getOrPut(key) { RateLimiter1250(strategy) }
