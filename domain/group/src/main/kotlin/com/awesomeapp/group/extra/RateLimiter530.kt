...
class RateLimiter530(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter530>()
    ...
    fun forKey(key: String): RateLimiter530 = perKeyLimiters.getOrPut(key) { RateLimiter530(strategy) }
