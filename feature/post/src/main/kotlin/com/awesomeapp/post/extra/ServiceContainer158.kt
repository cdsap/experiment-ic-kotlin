...
class ServiceContainer158 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer158) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer158) -> T
    ): ServiceContainer158 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer158) -> T
