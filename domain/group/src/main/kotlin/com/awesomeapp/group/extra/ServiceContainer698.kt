...
class ServiceContainer698 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer698) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer698) -> T
    ): ServiceContainer698 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer698) -> T
