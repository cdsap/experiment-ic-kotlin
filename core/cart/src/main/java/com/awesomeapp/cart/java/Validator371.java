...
/**
 * Validation framework class 371 with rule-based validation.
 */
public class Validator371<T> {
    ...
    public Validator371<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator371<T> stopOnFirst(boolean stop) {
