...
class RateLimiter910(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter910>()
    ...
    fun forKey(key: String): RateLimiter910 = perKeyLimiters.getOrPut(key) { RateLimiter910(strategy) }
