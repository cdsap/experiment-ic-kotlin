...
/**
 * Validation framework class 366 with rule-based validation.
 */
public class Validator366<T> {
    ...
    public Validator366<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator366<T> stopOnFirst(boolean stop) {
