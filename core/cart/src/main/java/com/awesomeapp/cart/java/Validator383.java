...
/**
 * Validation framework class 383 with rule-based validation.
 */
public class Validator383<T> {
    ...
    public Validator383<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator383<T> stopOnFirst(boolean stop) {
