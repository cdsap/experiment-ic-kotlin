package com.awesomeapp.user.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Factory600 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory600 withType(String type) { this.type = type; return this; }

    public Factory600 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory600 withProperties(Map<String, Object> props) {
    ...
    public Factory600 reset() { properties.clear(); type = "default"; return this; }
}
