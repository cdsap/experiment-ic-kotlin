...
public class Factory902 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory902 withType(String type) { this.type = type; return this; }

    public Factory902 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory902 withProperties(Map<String, Object> props) {
    ...
    public Factory902 reset() { properties.clear(); type = "default"; return this; }
}
