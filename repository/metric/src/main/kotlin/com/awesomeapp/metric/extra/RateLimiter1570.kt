...
class RateLimiter1570(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1570>()
    ...
    fun forKey(key: String): RateLimiter1570 = perKeyLimiters.getOrPut(key) { RateLimiter1570(strategy) }
