...
class RateLimiter330(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter330>()
    ...
    fun forKey(key: String): RateLimiter330 = perKeyLimiters.getOrPut(key) { RateLimiter330(strategy) }
