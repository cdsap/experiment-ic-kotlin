...
public class Builder318 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder318 withType(String type) { this.type = type; return this; }

    public Builder318 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder318 withProperties(Map<String, Object> props) {
    ...
    public Builder318 reset() { properties.clear(); type = "default"; return this; }
}
