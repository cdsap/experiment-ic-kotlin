...
class RateLimiter890(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter890>()
    ...
    fun forKey(key: String): RateLimiter890 = perKeyLimiters.getOrPut(key) { RateLimiter890(strategy) }
