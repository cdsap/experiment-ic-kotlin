...
/**
 * Validation framework class 354 with rule-based validation.
 */
public class Validator354<T> {
    ...
    public Validator354<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator354<T> stopOnFirst(boolean stop) {
