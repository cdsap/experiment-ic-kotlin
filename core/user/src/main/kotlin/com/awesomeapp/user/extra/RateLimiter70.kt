...
class RateLimiter70(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter70>()
    ...
    fun forKey(key: String): RateLimiter70 = perKeyLimiters.getOrPut(key) { RateLimiter70(strategy) }
