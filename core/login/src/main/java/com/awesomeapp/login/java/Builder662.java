...
public class Builder662 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder662 withType(String type) { this.type = type; return this; }

    public Builder662 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder662 withProperties(Map<String, Object> props) {
    ...
    public Builder662 reset() { properties.clear(); type = "default"; return this; }
}
