...
/**
 * Validation framework class 394 with rule-based validation.
 */
public class Validator394<T> {
    ...
    public Validator394<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator394<T> stopOnFirst(boolean stop) {
