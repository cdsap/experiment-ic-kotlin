...
class RateLimiter970(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter970>()
    ...
    fun forKey(key: String): RateLimiter970 = perKeyLimiters.getOrPut(key) { RateLimiter970(strategy) }
