...
class ServiceContainer1118 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1118) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1118) -> T
    ): ServiceContainer1118 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1118) -> T
