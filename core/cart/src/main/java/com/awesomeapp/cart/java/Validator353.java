...
/**
 * Validation framework class 353 with rule-based validation.
 */
public class Validator353<T> {
    ...
    public Validator353<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator353<T> stopOnFirst(boolean stop) {
