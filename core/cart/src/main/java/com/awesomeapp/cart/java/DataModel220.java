...
public class DataModel220 {
    ...
    public DataModel220(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel220{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
    ...
    public boolean equals(Object o) {
        ...
        DataModel220 that = (DataModel220) o;
