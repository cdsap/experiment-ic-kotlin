...
class RateLimiter30(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter30>()
    ...
    fun forKey(key: String): RateLimiter30 = perKeyLimiters.getOrPut(key) { RateLimiter30(strategy) }
