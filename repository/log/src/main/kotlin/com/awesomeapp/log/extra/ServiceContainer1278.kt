...
class ServiceContainer1278 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1278) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1278) -> T
    ): ServiceContainer1278 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1278) -> T
