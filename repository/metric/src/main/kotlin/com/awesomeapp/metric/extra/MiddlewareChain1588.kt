...
class MiddlewareChain1588<Req : Any, Res : Any> {
    ...
    fun use(middleware: Middleware<Req, Res>): MiddlewareChain1588<Req, Res> {
    ...
    fun onError(handler: suspend (Throwable, Context<Req, Res>) -> Unit): MiddlewareChain1588<Req, Res> {
