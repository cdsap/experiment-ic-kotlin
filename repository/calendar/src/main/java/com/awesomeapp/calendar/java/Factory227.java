...
public class Factory227 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory227 withType(String type) { this.type = type; return this; }

    public Factory227 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory227 withProperties(Map<String, Object> props) {
    ...
    public Factory227 reset() { properties.clear(); type = "default"; return this; }
}
