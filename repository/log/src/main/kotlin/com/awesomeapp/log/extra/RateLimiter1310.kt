...
class RateLimiter1310(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1310>()
    ...
    fun forKey(key: String): RateLimiter1310 = perKeyLimiters.getOrPut(key) { RateLimiter1310(strategy) }
