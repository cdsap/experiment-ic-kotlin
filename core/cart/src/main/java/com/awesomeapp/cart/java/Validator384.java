...
/**
 * Validation framework class 384 with rule-based validation.
 */
public class Validator384<T> {
    ...
    public Validator384<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator384<T> stopOnFirst(boolean stop) {
