...
class RateLimiter310(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter310>()
    ...
    fun forKey(key: String): RateLimiter310 = perKeyLimiters.getOrPut(key) { RateLimiter310(strategy) }
