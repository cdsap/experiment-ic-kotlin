...
class RateLimiter370(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter370>()
    ...
    fun forKey(key: String): RateLimiter370 = perKeyLimiters.getOrPut(key) { RateLimiter370(strategy) }
