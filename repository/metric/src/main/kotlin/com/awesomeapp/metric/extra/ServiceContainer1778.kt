...
class ServiceContainer1778 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1778) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1778) -> T
    ): ServiceContainer1778 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1778) -> T
