...
class RateLimiter1330(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1330>()
    ...
    fun forKey(key: String): RateLimiter1330 = perKeyLimiters.getOrPut(key) { RateLimiter1330(strategy) }
