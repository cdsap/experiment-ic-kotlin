...
class ServiceContainer1538 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1538) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1538) -> T
    ): ServiceContainer1538 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1538) -> T
