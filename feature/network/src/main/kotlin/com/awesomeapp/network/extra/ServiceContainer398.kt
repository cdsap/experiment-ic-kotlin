...
class ServiceContainer398 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer398) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer398) -> T
    ): ServiceContainer398 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer398) -> T
