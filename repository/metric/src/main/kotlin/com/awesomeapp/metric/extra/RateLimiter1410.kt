...
class RateLimiter1410(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1410>()
    ...
    fun forKey(key: String): RateLimiter1410 = perKeyLimiters.getOrPut(key) { RateLimiter1410(strategy) }
