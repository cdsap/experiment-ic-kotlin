...
/**
 * Validation framework class 351 with rule-based validation.
 */
public class Validator351<T> {
    ...
    public Validator351<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator351<T> stopOnFirst(boolean stop) {
