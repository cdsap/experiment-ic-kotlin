package com.awesomeapp.event.java;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class Factory447 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory447 withType(String type) { this.type = type; return this; }

    public Factory447 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory447 withProperties(Map<String, Object> props) {
    ...
    public Factory447 reset() { properties.clear(); type = "default"; return this; }
}
