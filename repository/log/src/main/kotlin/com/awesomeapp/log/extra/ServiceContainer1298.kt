...
class ServiceContainer1298 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1298) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1298) -> T
    ): ServiceContainer1298 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1298) -> T
