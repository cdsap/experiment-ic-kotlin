...
/**
 * Validation framework class 400 with rule-based validation.
 */
public class Validator400<T> {
    ...
    public Validator400<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator400<T> stopOnFirst(boolean stop) {
