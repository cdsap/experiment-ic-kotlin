...
class RateLimiter130(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter130>()
    ...
    fun forKey(key: String): RateLimiter130 = perKeyLimiters.getOrPut(key) { RateLimiter130(strategy) }
