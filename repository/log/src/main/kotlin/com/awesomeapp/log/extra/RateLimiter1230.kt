...
class RateLimiter1230(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1230>()
    ...
    fun forKey(key: String): RateLimiter1230 = perKeyLimiters.getOrPut(key) { RateLimiter1230(strategy) }
