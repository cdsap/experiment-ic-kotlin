...
class RateLimiter850(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter850>()
    ...
    fun forKey(key: String): RateLimiter850 = perKeyLimiters.getOrPut(key) { RateLimiter850(strategy) }
