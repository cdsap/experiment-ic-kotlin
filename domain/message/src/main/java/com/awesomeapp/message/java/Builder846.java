...
public class Builder846 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder846 withType(String type) { this.type = type; return this; }

    public Builder846 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder846 withProperties(Map<String, Object> props) {
    ...
    public Builder846 reset() { properties.clear(); type = "default"; return this; }
}
