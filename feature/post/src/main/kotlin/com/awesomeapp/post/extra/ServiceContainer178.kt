...
class ServiceContainer178 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer178) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer178) -> T
    ): ServiceContainer178 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer178) -> T
