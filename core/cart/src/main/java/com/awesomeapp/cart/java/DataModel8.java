...
/**
 * Simple data model class 8.
 */
public class DataModel8 {
    private String id;
    private String name;
    private int value;
    ...
    public DataModel8(String id, String name, int value, boolean active) {
        this.id = id;
        this.name = name;
        this.value = value;
        this.active = active;
    ...
    public String toString() {
        return "DataModel8{id='" + id + "', name='" + name + "', value=" + value + ", active=" + active + "}";
    }
