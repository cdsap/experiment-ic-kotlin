...
public class Factory671 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory671 withType(String type) { this.type = type; return this; }

    public Factory671 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory671 withProperties(Map<String, Object> props) {
    ...
    public Factory671 reset() { properties.clear(); type = "default"; return this; }
}
