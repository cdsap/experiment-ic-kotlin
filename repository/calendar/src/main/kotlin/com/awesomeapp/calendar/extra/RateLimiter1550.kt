...
class RateLimiter1550(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1550>()
    ...
    fun forKey(key: String): RateLimiter1550 = perKeyLimiters.getOrPut(key) { RateLimiter1550(strategy) }
