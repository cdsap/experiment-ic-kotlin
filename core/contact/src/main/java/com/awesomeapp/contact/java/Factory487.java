...
public class Factory487 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory487 withType(String type) { this.type = type; return this; }

    public Factory487 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory487 withProperties(Map<String, Object> props) {
    ...
    public Factory487 reset() { properties.clear(); type = "default"; return this; }
}
