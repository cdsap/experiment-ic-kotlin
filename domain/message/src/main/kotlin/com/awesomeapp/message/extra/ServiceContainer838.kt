...
class ServiceContainer838 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer838) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer838) -> T
    ): ServiceContainer838 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer838) -> T
