...
class RateLimiter1030(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1030>()
    ...
    fun forKey(key: String): RateLimiter1030 = perKeyLimiters.getOrPut(key) { RateLimiter1030(strategy) }
