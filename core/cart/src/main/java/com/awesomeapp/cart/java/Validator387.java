...
/**
 * Validation framework class 387 with rule-based validation.
 */
public class Validator387<T> {
    ...
    public Validator387<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator387<T> stopOnFirst(boolean stop) {
