...
/**
 * Validation framework class 377 with rule-based validation.
 */
public class Validator377<T> {
    ...
    public Validator377<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator377<T> stopOnFirst(boolean stop) {
