...
class ServiceContainer238 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer238) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer238) -> T
    ): ServiceContainer238 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer238) -> T
