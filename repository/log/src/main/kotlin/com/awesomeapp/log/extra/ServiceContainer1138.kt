...
class ServiceContainer1138 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1138) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1138) -> T
    ): ServiceContainer1138 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1138) -> T
