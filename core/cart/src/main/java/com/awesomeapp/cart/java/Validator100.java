...
/**
 * Validation framework class with rule-based validation.
 */
public class Validator100<T> {
    ...
    public Validator100<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator100<T> stopOnFirst(boolean stop) {
