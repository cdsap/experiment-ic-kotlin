...
class ServiceContainer1178 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1178) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1178) -> T
    ): ServiceContainer1178 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1178) -> T
