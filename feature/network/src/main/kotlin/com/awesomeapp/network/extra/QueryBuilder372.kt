...
class QueryBuilder372 {
    ...
    sealed class Expression {
        ...
        data class SubQuery(val query: QueryBuilder372) : Expression()
    }
    ...
    sealed class Condition {
        ...
        data class Exists(val subQuery: QueryBuilder372) : Condition()
    ...
    fun from(table: String, alias: String? = null): QueryBuilder372 {
        this.table = table; this.tableAlias = alias; return this
    }

    fun select(vararg fields: String): QueryBuilder372 {
        fields.forEach { selectFields.add(Expression.Field(it) to null) }; return this
    }

    fun selectAs(field: String, alias: String): QueryBuilder372 {
        selectFields.add(Expression.Field(field) to alias); return this
    }

    fun selectExpr(expr: Expression, alias: String? = null): QueryBuilder372 {
        selectFields.add(expr to alias); return this
    }

    fun distinct(): QueryBuilder372 { distinct = true; return this }

    fun where(condition: Condition): QueryBuilder372 { conditions.add(condition); return this }
    fun whereEq(field: String, value: Any?): QueryBuilder372 { conditions.add(Condition.Comparison(field, CompOp.EQ, value)); return this }
    fun whereGt(field: String, value: Any): QueryBuilder372 { conditions.add(Condition.Comparison(field, CompOp.GT, value)); return this }
    fun whereLt(field: String, value: Any): QueryBuilder372 { conditions.add(Condition.Comparison(field, CompOp.LT, value)); return this }
    fun whereBetween(field: String, low: Any, high: Any): QueryBuilder372 { conditions.add(Condition.Between(field, low, high)); return this }
    fun whereIn(field: String, values: List<Any>): QueryBuilder372 { conditions.add(Condition.In(field, values)); return this }
    fun whereNull(field: String): QueryBuilder372 { conditions.add(Condition.IsNull(field)); return this }
    fun whereNotNull(field: String): QueryBuilder372 { conditions.add(Condition.IsNotNull(field)); return this }
    fun whereLike(field: String, pattern: String): QueryBuilder372 { conditions.add(Condition.Like(field, pattern)); return this }
    fun whereNot(condition: Condition): QueryBuilder372 { conditions.add(Condition.Not(condition)); return this }
    fun whereExists(subQuery: QueryBuilder372): QueryBuilder372 { conditions.add(Condition.Exists(subQuery)); return this }

    fun join(table: String, on: Condition, type: JoinType = JoinType.INNER, alias: String? = null): QueryBuilder372 {
    ...
    fun orderBy(field: String, direction: OrderDir = OrderDir.ASC): QueryBuilder372 {
        orderBys.add(OrderBy(field, direction)); return this
    }

    fun groupBy(vararg fields: String, having: Condition? = null): QueryBuilder372 {
        groupBy = GroupBy(fields.toList(), having); return this
    }

    fun limit(limit: Int): QueryBuilder372 { limitValue = limit; return this }
    fun offset(offset: Int): QueryBuilder372 { offsetValue = offset; return this }
