...
class ServiceContainer638 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer638) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer638) -> T
    ): ServiceContainer638 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer638) -> T
