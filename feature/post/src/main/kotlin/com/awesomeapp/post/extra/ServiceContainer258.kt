...
class ServiceContainer258 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer258) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer258) -> T
    ): ServiceContainer258 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer258) -> T
