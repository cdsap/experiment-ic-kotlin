...
/**
 * Validation framework class 367 with rule-based validation.
 */
public class Validator367<T> {
    ...
    public Validator367<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator367<T> stopOnFirst(boolean stop) {
