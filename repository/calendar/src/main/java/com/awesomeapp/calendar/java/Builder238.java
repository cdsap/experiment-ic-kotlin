...
public class Builder238 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder238 withType(String type) { this.type = type; return this; }

    public Builder238 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder238 withProperties(Map<String, Object> props) {
    ...
    public Builder238 reset() { properties.clear(); type = "default"; return this; }
}
