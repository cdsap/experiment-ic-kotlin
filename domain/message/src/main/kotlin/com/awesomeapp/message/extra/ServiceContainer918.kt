...
class ServiceContainer918 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer918) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer918) -> T
    ): ServiceContainer918 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer918) -> T
