...
/**
 * Validation framework class 355 with rule-based validation.
 */
public class Validator355<T> {
    ...
    public Validator355<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator355<T> stopOnFirst(boolean stop) {
