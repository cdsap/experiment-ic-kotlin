...
/**
 * Validation framework class 385 with rule-based validation.
 */
public class Validator385<T> {
    ...
    public Validator385<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator385<T> stopOnFirst(boolean stop) {
