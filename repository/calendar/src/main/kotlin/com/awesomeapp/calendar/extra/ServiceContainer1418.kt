...
class ServiceContainer1418 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1418) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1418) -> T
    ): ServiceContainer1418 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1418) -> T
