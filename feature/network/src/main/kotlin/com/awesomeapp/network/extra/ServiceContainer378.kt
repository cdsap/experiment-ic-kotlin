...
class ServiceContainer378 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer378) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer378) -> T
    ): ServiceContainer378 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer378) -> T
