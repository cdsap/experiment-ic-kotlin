...
class RateLimiter1790(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1790>()
    ...
    fun forKey(key: String): RateLimiter1790 = perKeyLimiters.getOrPut(key) { RateLimiter1790(strategy) }
