...
class ServiceContainer1658 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1658) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1658) -> T
    ): ServiceContainer1658 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1658) -> T
