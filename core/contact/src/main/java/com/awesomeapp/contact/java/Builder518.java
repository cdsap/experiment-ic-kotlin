...
public class Builder518 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder518 withType(String type) { this.type = type; return this; }

    public Builder518 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder518 withProperties(Map<String, Object> props) {
    ...
    public Builder518 reset() { properties.clear(); type = "default"; return this; }
}
