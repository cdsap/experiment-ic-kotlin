...
class RateLimiter610(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter610>()
    ...
    fun forKey(key: String): RateLimiter610 = perKeyLimiters.getOrPut(key) { RateLimiter610(strategy) }
