...
class ServiceContainer38 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer38) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer38) -> T
    ): ServiceContainer38 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer38) -> T
