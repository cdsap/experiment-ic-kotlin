...
/**
 * Validation framework class 376 with rule-based validation.
 */
public class Validator376<T> {
    ...
    public Validator376<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator376<T> stopOnFirst(boolean stop) {
