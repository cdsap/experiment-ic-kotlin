...
public class StateMachine2042<S, E> {
    ...
    public StateMachine2042(S initialState) {
        this.currentState = initialState;
    }

    public StateMachine2042<S, E> addTransition(S from, E event, S to) {
        return addTransition(from, event, to, null, null);
    }

    public StateMachine2042<S, E> addTransition(S from, E event, S to, Predicate<E> guard, Consumer<E> action) {
        transitionTable
    ...
    public StateMachine2042<S, E> onTransition(Consumer<TransitionResult<S>> listener) {
