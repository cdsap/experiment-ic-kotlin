...
class ServiceContainer658 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer658) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer658) -> T
    ): ServiceContainer658 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer658) -> T
