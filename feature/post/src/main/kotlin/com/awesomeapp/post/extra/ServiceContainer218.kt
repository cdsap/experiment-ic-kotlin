...
class ServiceContainer218 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer218) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer218) -> T
    ): ServiceContainer218 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer218) -> T
