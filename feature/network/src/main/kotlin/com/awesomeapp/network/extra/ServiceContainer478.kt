...
class ServiceContainer478 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer478) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer478) -> T
    ): ServiceContainer478 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer478) -> T
