...
class RateLimiter1150(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1150>()
    ...
    fun forKey(key: String): RateLimiter1150 = perKeyLimiters.getOrPut(key) { RateLimiter1150(strategy) }
