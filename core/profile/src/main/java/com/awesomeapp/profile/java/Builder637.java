...
public class Builder637 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder637 withType(String type) { this.type = type; return this; }

    public Builder637 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder637 withProperties(Map<String, Object> props) {
    ...
    public Builder637 reset() { properties.clear(); type = "default"; return this; }
}
