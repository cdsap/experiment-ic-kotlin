...
public class Builder498 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Builder498 withType(String type) { this.type = type; return this; }

    public Builder498 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Builder498 withProperties(Map<String, Object> props) {
    ...
    public Builder498 reset() { properties.clear(); type = "default"; return this; }
}
