...
/**
 * Validation framework class 369 with rule-based validation.
 */
public class Validator369<T> {
    ...
    public Validator369<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator369<T> stopOnFirst(boolean stop) {
