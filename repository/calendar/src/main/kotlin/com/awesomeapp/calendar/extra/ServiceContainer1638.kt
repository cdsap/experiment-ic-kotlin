...
class ServiceContainer1638 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1638) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1638) -> T
    ): ServiceContainer1638 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1638) -> T
