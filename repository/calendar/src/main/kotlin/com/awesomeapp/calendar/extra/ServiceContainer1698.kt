...
class ServiceContainer1698 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1698) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1698) -> T
    ): ServiceContainer1698 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1698) -> T
