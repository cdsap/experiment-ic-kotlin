...
class RateLimiter630(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter630>()
    ...
    fun forKey(key: String): RateLimiter630 = perKeyLimiters.getOrPut(key) { RateLimiter630(strategy) }
