...
/**
 * Validation framework class 373 with rule-based validation.
 */
public class Validator373<T> {
    ...
    public Validator373<T> addRule(String field, String message, Predicate<T> condition) {
        rules.add(new ValidationRule<>(field, message, condition));
        return this;
    }

    public Validator373<T> stopOnFirst(boolean stop) {
