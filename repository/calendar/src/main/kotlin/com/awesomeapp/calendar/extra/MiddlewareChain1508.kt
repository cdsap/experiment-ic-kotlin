...
class MiddlewareChain1508<Req : Any, Res : Any> {
    ...
    fun use(middleware: Middleware<Req, Res>): MiddlewareChain1508<Req, Res> {
    ...
    fun onError(handler: suspend (Throwable, Context<Req, Res>) -> Unit): MiddlewareChain1508<Req, Res> {
