...
class ServiceContainer1438 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1438) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1438) -> T
    ): ServiceContainer1438 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1438) -> T
