...
class ServiceContainer1218 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer1218) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer1218) -> T
    ): ServiceContainer1218 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer1218) -> T
