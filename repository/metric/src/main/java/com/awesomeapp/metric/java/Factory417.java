...
public class Factory417 {
    private final Map<String, Object> properties = new HashMap<>();
    private String type = "default";

    public Factory417 withType(String type) { this.type = type; return this; }

    public Factory417 withProperty(String key, Object value) {
        properties.put(key, value); return this;
    }

    public Factory417 withProperties(Map<String, Object> props) {
    ...
    public Factory417 reset() { properties.clear(); type = "default"; return this; }
}
