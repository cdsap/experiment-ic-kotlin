...
class RateLimiter1290(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter1290>()
    ...
    fun forKey(key: String): RateLimiter1290 = perKeyLimiters.getOrPut(key) { RateLimiter1290(strategy) }
