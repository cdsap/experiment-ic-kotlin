...
class ServiceContainer458 {
    ...
    data class ServiceDescriptor(
        ...
        val factory: suspend (ServiceContainer458) -> Any,
    ...
    fun <T : Any> register(
        ...
        priority: Int = 0, factory: suspend (ServiceContainer458) -> T
    ): ServiceContainer458 {
    ...
    inline fun <reified T : Any> register(
        ...
        name: String? = null, tags: Set<String> = emptySet(),
        noinline factory: suspend (ServiceContainer458) -> T
