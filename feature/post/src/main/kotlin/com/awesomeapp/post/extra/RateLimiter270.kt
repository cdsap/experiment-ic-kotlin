...
class RateLimiter270(private val strategy: Strategy) {
    ...
    private val perKeyLimiters = ConcurrentHashMap<String, RateLimiter270>()
    ...
    fun forKey(key: String): RateLimiter270 = perKeyLimiters.getOrPut(key) { RateLimiter270(strategy) }
